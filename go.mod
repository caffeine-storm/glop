...
replace github.com/go-gl-legacy/gl => github.com/caffeine-storm/gl v0.0.0-20240822160436-13feedee09f9
...
require (
	...
	github.com/runningwild/opengl v0.0.0-20120403195019-a84b3617440e
