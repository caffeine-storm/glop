...
// All values are between 0 and 1, inclusive. wx,wy represent a point on the
// widget, and bx,by represent a point on the AnchorBox. During layout the
// widget will be positioned such that these points line up.
type Anchor struct {
	Wx, Wy, Bx, By float64
}

// An AnchorBox does layout according to Anchors. An anchor must be specified
